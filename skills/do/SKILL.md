...
allowed-tools: ["Bash(.codex/skills/do/scripts/setup-do.py:*)", "Bash(.codex/skills/do/scripts/task.py:*)"]
---
...
```bash
python3 ".codex/skills/do/scripts/setup-do.py" "<task description>"
```
...
```bash
# Update phase
python3 ".codex/skills/do/scripts/task.py" update-phase 2

# Check status
python3 ".codex/skills/do/scripts/task.py" status

# List all tasks
python3 ".codex/skills/do/scripts/task.py" list
```
...
1. Run setup with `--worktree` flag to create the worktree:
   ```bash
   python3 ".codex/skills/do/scripts/setup-do.py" --worktree "<task description>"
   ```
